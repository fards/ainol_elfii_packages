...
public class MenuExecutor {
    ...
    public void startAction(int action, int title, ProgressListener listener) {
        ...
        if(activity.getResources().getBoolean(R.bool.config_deletetips_enable)){      
        	if(title == R.string.delete){
        		if(mTask != null)
        			Toast.makeText(activity,activity.getString(R.string.activity_delete_success),2000).show();
        		else
        			Toast.makeText(activity,activity.getString(R.string.activity_delete_fail),2000).show();
        }
      }
    }
