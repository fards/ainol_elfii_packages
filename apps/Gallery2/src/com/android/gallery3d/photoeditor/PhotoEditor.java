                            ...
                            public void onDone(Bitmap bitmap) {
                                SaveCopyTask.Callback callback = new SaveCopyTask.Callback() {
                                    ...
                                    public void onComplete(Uri result) {
                                        ...
                                        mIntent.putExtra(Intent.EXTRA_STREAM, saveUri);
                                        mIntent.setType("image/*");					
                                        List<ResolveInfo> activities = getPackageManager().queryIntentActivities(mIntent, 0);     	  	                                 									 
                                        if(activities.size()!=0) 
                                            actionBar.updateSave(saveUri == null,true);
                                        else
                                            actionBar.updateSave(saveUri == null,false);
