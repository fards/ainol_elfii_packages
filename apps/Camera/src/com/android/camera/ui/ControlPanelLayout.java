...
public class ControlPanelLayout extends RelativeLayout {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
		...
		Log.d(TAG,"longSideSize = "+String.valueOf(longSideSize)+" shortSideSize = "+String.valueOf(shortSideSize));
		int minWidth = mContext.getResources().getInteger(R.integer.MinControlBarWidth);
