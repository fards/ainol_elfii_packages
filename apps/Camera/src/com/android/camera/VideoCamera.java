    ...
    private class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
				...
				Log.d(TAG,"receive media eject "+uri.toString());
                if(new File(Storage.DCIM).equals(uri)){
...
*/
	...
	public void run() {
		/*
			if(VideoCamera.this.isTaskRoot() == true) {
    ...
    private void startVideoRecording() {
		...
		Log.d(TAG,"first to updateRecordingTime");
        updateRecordingTime();
        keepScreenOn();
    }
    ...
    private void updateRecordingTime() {
		...
		Log.d(TAG,"updateRecordingTime "+String.valueOf(deltaAdjusted));
		...
		Log.d(TAG,"updateRecordingTime end "+String.valueOf(deltaAdjusted));
    }
    ...
    private void showTapToSnapshotToast() {
		if(VideoCamera.this.getResources().getBoolean(R.bool.config_cmaeratips_enable)){
