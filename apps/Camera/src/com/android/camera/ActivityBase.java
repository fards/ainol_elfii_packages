...
abstract public class ActivityBase extends Activity {
    ...
    public void onCreate(Bundle icicle) {
		if(ActivityBase.this.getResources().getBoolean(R.bool.TabletUsePhoneUI)==true) {
			//now we use phone ui, but it is modified to landscape not portait
    ...
    protected void onResume() {
        super.onResume();
		if (IfHdmi.isCameraValid(this) == false) {
			finish();
			return;
		}
