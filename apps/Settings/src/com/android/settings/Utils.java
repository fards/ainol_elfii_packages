...
public class Utils {
    ...
    public static boolean hwHasAccelerometer() {
        return SystemProperties.getBoolean("hw.has.accelerometer", true);
    }
    ...
    public static boolean platformHasHdmiDualDisp() {
        return SystemProperties.getBoolean("ro.vout.dualdisplay2", false);
    }
    ...
    public static boolean platformHasHdmiSettings() {
        return platformHasHdmiDualDisp() || platformHasHdmiSpdif();
    } 
