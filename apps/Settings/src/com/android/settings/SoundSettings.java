...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_CATEGORY_CALLS_AND_NOTIFICATION = "category_calls_and_notification";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Do not display Ringtone when don't surport voice call( dgt edited)
        ...
        if (Utils.hwNoSoundPartition()){
            getPreferenceScreen().removePreference(findPreference(KEY_CATEGORY_CALLS_AND_NOTIFICATION));
            getPreferenceScreen().removePreference(mNotificationPreference);
            getPreferenceScreen().removePreference(mLockSounds);
        }

		if (Utils.hwNoSoundCategoryFeedback()){
			getPreferenceScreen().removePreference(findPreference(KEY_SOUND_CATEGORY_FEEDBACK));
