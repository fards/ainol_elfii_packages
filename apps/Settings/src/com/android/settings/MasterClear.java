...
public class MasterClear extends Fragment {
    ...
    private void establishInitialState() {
        ...
        if (isExtStorageEmulated
            ...
            final TextView erase_external_title = (TextView) mContentView.findViewById(R.id.erase_external_title);
            final TextView erase_external_summary = (TextView) mContentView.findViewById(R.id.erase_external_summary);

			/*
            if (!Environment.isExternalStorageBeSdcard()) {
            	Resources res = getActivity().getResources();
            	erase_external_title.setText(res.getText(R.string.erase_internal_sd_card_storage));
            	erase_external_summary.setText(res.getText(R.string.erase_internal_sd_card_storage_description));        		
            }*/
