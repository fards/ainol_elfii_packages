...
public class StorageVolumePreferenceCategory extends PreferenceCategory implements
    ...
    public StorageVolumePreferenceCategory(Context context, Resources resources,
        ...
        if (storageVolume != null) {
            String label = storageManager.getVolumeFSLabel(storageVolume.getPath());
            if (label != null && label.length() != 0) {
                setTitle(storageVolume.getDescription() + " - " + label);
            } else {
                setTitle(storageVolume.getDescription());
            }
        } else {
            setTitle(resources.getText(R.string.internal_storage));
        }
    ...
    public void init() {
        ...
        String device = mStorageVolume != null
