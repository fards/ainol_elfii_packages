...
public class DisplayPositionSetConfirm extends Activity {
	...
	if(get_operation == GET_USER_OPERATION){
		if(Utils.platformHas1080Scale() == 2){
			...
			messages = getResources().getString(R.string.display_position_set_confirm_dialog);
		}
	}
		...
		if(Utils.platformHas1080Scale() == 2){
			...
			messages = getResources().getString(R.string.display_position_set_default_confirm_dialog);
		}
	}
	showDispmodeSetMsg();  
    }
