...
public class CryptKeeper extends Activity implements TextView.OnEditorActionListener {
    ...
    private static final String USERDATA_MOUNT_POINTER = "/data";
    ...
    private boolean mUserdataMounted;
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mUserdataMounted = "mounted".equals(SystemProperties.get("ro.userdata.state"));

        SystemProperties.set("CryptKeeper.state", "start");
        
        // If we are not encrypted or encrypting, get out quickly.
        String state = SystemProperties.get("vold.decrypt");
        if (!isDebugView() && ( ("".equals(state) &&  mUserdataMounted) || DECRYPT_STATE.equals(state))) {
    ...
    private void setupUi() {
        if (!mUserdataMounted || mEncryptionGoneBad || isDebugView(FORCE_VIEW_ERROR)) {
    ...
    public void onStop() {
        ...
        SystemProperties.set("CryptKeeper.state", "finish");
    }
    ...
    private void showFactoryReset() {
        ...
        if(!mUserdataMounted){
            ...
            tv.setText(R.string.userdata_mount_failed_title);

            tv = (TextView) findViewById(R.id.status);
            tv.setText(R.string.userdata_mount_failed_summary);
        }else{
            TextView tv = (TextView) findViewById(R.id.title);
