...
public class Controller
    ...
    protected void onPause() {
        ...
        getContext().unregisterReceiver(mHdmiPluggedReceiver);        
    }
    ...
    void onResume() {
        ...
        Intent intent = getContext().registerReceiver(mHdmiPluggedReceiver, filter);
        if (intent != null) {
    ...
    @Override
    // changed logic of mCrashRecoveryHandler.backupState and mUi.onProgressChanged
    ...
    public void startVoiceSearch() {
        ...
        mActivity.startActivity(intent);
            ...
            Log.e(LOGTAG, "Speed search activity not found: " + RecognizerIntent.ACTION_WEB_SEARCH);
        }
    }
