...
//add sz.wu.zhu 20111215 
    private String mFileToPlayDataPath;
            ...
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                        ...
                        if (mFileToPlayDataPath != null && mFileToPlayDataPath.startsWith(path)) {
                        	saveQueue(true);
...
//            ed.apply();
    ...
    public void open(String path) {
        synchronized (this) {
            ...
            mFileToPlayDataPath = getDataPath();
            mFileToPlay = path;
